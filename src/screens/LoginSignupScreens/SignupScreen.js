            ...
            {successmsg == null ?
                <View style={styles.container}>
                    ...
                    <View style={styles.inputout}>
                        <AntDesign name="user" size={24} color={namefocus === true ? '#FF6402' : '#2C422B'} />
                    ...
                    <View style={styles.inputout}>
                        <Entypo name="email" size={24} color={emailfocus === true ? '#FF6402' : '#2C422B'} />
                    ...
                    <View style={styles.inputout}>
                        <Feather name="smartphone" size={24} color={phonefocus === true ? '#FF6402' : '#2C422B'} />
                    ...
                    {/* password start */}
                    <View style={styles.inputout}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color={passwordfocus == true ? '#FF6402' : '#2C422B'} />
                    ...
                    {/*  */}
                    <View style={styles.inputout}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color={cpasswordfocus == true ? '#FF6402' : '#2C422B'} />
                    ...
                    <TouchableOpacity style={btn1} onPress={() => handleSignup()}>
                        <Text style={{ color: '#ffff', fontSize: titles.btntxt, fontWeight: "bold" }}>Sign up</Text>
                    </TouchableOpacity>
                ...
                <View style={styles.container1}>
                    ...
                    <TouchableOpacity style={btn1} onPress={() => navigation.navigate('login')}>
                        <Text style={{ color: "#ffff", fontSize: titles.btntxt, fontWeight: "bold" }}>Sign In</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={btn1} onPress={() => setSuccessmsg(null)}>
                        <Text style={{ color: "#ffff", fontSize: titles.btntxt, fontWeight: "bold" }}>Go Back</Text>
                    </TouchableOpacity>
                </View>
